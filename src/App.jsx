...
export default function App() {
  ...
  return (
    <div className="bg-[#050505] text-white min-h-screen font-sans selection:bg-cyan-500/30">
      ...
      >
        <div className="h-full flex flex-col items-center justify-start pt-64 gap-8" onClick={(e) => e.stopPropagation()}>
      ...
      < section id="profile" className="py-24 px-6 md:px-20 relative bg-[#0a0a0a]" >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <FadeInSection>
            <div
              className="relative group bg-rose-200 transition-all duration-[2000ms] film-grain"
              onContextMenu={(e) => e.preventDefault()}
            >
              <div className="absolute -top-10 -left-10 w-32 h-32 border-t border-l border-rose-900/50"></div>
              <img
                src={IMAGES.profile1}
                alt="Profile"
          ...
          <FadeInSection delay={200}>
            <div>
              ...
              <div className="space-y-6 text-sm md:text-base text-gray-400 font-light leading-loose text-justify">
                <p>
                  17歳で挑んだ『Girls Planet 999』。その経験を糧に、彼女は「寺崎ひな」として進化しました。 現在は作詞・作曲のみならず、ディレクションまでを自ら手掛けるシンガーソングライターへ。
                </p>
                <p>
                  「言葉にできない感情を、音にする」
                </p>
                <p>
                  彼女が操るのは「静」と「動」。心に寄り添う繊細なバラードから、感情を鋭く刻むラップまで、ジャンルの壁を軽々と越えていきます。
                </p>
              </div>
